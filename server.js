...
app.use(express.static("public")); // serve index.html + photos from /public


// API keys are live in .env which is in .gitignore
...
// /subscribe - add a subscriber and send them a welcome email
app.post("/subscribe", async (req, res) => {
  ...
  try {
      ...
      body: JSON.stringify({
        ...
        Content: {
          ...
          Body: [
            {
              ContentType: "HTML",
              Content: "<strong>Thanks for subscribing to the DEV@Deakin Daily Insider newsletter!</strong>",
            },
          ],
        },
      }),
    ...
    // Elastic Email returns 200 OK once the email is accepted for delivery
